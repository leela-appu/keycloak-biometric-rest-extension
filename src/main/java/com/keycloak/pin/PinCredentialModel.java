...
public class PinCredentialModel extends CredentialModel {
    ...
    public static PinCredentialModel create(String deviceId, String credentialPublicKey, String securePin) {
        PinCredentialData credentialData = new PinCredentialData(deviceId, credentialPublicKey, securePin);
    ...
    public PinSecretData getPinSecretData() {
        return secretData;
    }
